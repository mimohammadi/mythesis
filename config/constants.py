...
class SystemModelEnums(BaseEnum):
    Number_of_processors = name_tuple(4, "Number of processor for parallel")  # 2
    M = name_tuple(2, "Number of FNs")#2
    K = name_tuple(10, "Number of MUEs")#5
    ...
    N = name_tuple(30, "Number of Tasks")#5
    ...
    p__u = name_tuple(0.1, " -10 mw Transmit Power of MUEs")
    p__m = name_tuple(0.2, " -20 mw Transmit Power of FNs")
    ...
    lambda_ = name_tuple(0.00025, "MUE distribution density")
